  ...
  <div class="d-progress-bar"
    ...
    <div class="warp">
      ...
      <div
          ...
          @mouseleave="eleave"
      >
        <div class="cllick-shadow absolute h-8 w-full -top-1/2 transform-gpu -translate-y-1/2"></div>
...
export default {
  ...
  methods: {
    ...
    progress_state_update() {
      let _ele, dataLen = this.data.length - 1;
      if (this.dataIndex >= dataLen) {
        ...
        this.$emit('bPlaying', {state: this.isPlaying, index: this.dataIndex});
      }
    ...
    playPause() {
      ...
      this.$emit('beforePlay', {state: this.isPlaying, index: this.dataIndex});
      if (this.isPlaying) {
